...
import io.github.novolmob.gradle.tools.vcs.utils.StringUtil.getGroupProjectFromProjectFullName
...
open class Gitlab(
    ...
    companion object {
        ...
        fun io.github.novolmob.gradle.tools.vcs.extension.VcsExtension.gitlab(action: Action<Gitlab>) {
